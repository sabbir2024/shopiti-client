...
const CustomerReviews = () => {
    ...
    return (
        <Container>
            <div className="text-3xl font-bold w-full uppercase pt-4">our happy customers</div>
            <div className="relative">
                <div className="w-full mx-auto h-[400px] flex flex-row items-center overflow-hidden gap-5 lg:gap-10">
                    <div className="overflow-hidden">
                        <div className="absolute flex right-0 -top-8 z-50 px-5">
                            {/* arrow left */}
